...
export default function NewApps() {
  ...
  const generateShareLink = async (app: DifyApp) => {
    // 加密应用配置信息
    const shareData = {
      id: app.id,
      name: app.name,
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        <div
                          className="flex-1 p-2 bg-muted rounded-md font-mono text-xs overflow-hidden"
                        ...
                        <Button
                          ...
                          className="h-8 w-8 p-0"
                          onClick={() =>
                            copyToClipboard(app.generatedApiKey, "Dify API Key")
                          }>
      ...
      <AlertDialog open={!!deleteApp} onOpenChange={() => setDeleteApp(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete "{deleteApp?.name}"? This action
              cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
